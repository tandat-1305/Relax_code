...
def about_us():
    tkinter.messagebox.showinfo('About PlayMusic','PlayMusic is written by a python learner, @tandat130502')
...
root.title("Melody")
root.iconbitmap("icon_headphone.ico")
